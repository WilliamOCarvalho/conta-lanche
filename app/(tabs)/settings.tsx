...
import { deleteHoliday, listHolidays, saveHoliday } from '../../src/db/repository';
...
export default function SettingsScreen() {
  ...
  const load = useCallback(() => { void listHolidays().then(setHolidays).catch(() => Alert.alert('Erro', 'Não foi possível carregar os feriados.')); }, []);
  useFocusEffect(load);
  const add = async () => {
